...
func TestGraphToNodeLinks(t *testing.T) {
	var urlTests = []struct {
...
google.golang.org/protobuf@v0.0.0-20200109180630-ec00e32a8dfd github.com/google/go-cmp@v0.3.0`},
	...
	for _, tt := range urlTests {
		actual1, actual2 := GraphToNodeLinks(tt.in)
		if (nil != actual1 && nil != actual2) != tt.expected {
			t.Errorf("GraphToNodeLinks(%s) = %v, %v; expected %t", tt.in, actual1, actual2, tt.expected)
		}
	}
}
